...
var Slider = function () {
  ...
  _createClass(Slider, [{
    ...
    value: function download(value, callback) {
      ...
      // this.el.lineDiff1.style.transition = `width ${delay}ms linear`;
      // this.el.lineDiff1.style.width = `${this.props.value * this.settings.step}%`;

      // this.el.lineDiff.style.transition = `width ${delay}ms linear`;
      ...
      var dur2 = delay - dur1;
      console.log(coeff, delay, dur1, dur2);
