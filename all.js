...
var Slider = function () {
  ...
  _createClass(Slider, [{
    ...
    value: function move(e) {
      ...
      var direction = this.settings.prevX - this.settings.currentX > 0 ? 'left' : 'right';
    ...
    value: function makeElements() {
      ...
      this.el.lineReal = (0, _dom.makeElement)('div', [this.props.clsPrefix + '-line', this.props.clsPrefix + '-line--real']);
...
exports.default = {
  questions: [{
    ...
    img: '<svg width="182.91" height="200" viewBox="0 0 182.91 200"><path fill="#00b9ff" d="M78.63 25.64A27.35 27.35 0 1 0 105.98 53a27.39 27.39 0 0 0-27.35-27.36zm0 51.28A23.93 23.93 0 1 1 102.56 53a24 24 0 0 1-23.93 23.92z"/><path fill="#00b9ff" d="M78.63 42.74A10.26 10.26 0 1 0 88.89 53a10.27 10.27 0 0 0-10.26-10.26zm0 17.09A6.84 6.84 0 1 1 85.45 53a6.84 6.84 0 0 1-6.82 6.83z"/><path fill="#d24b91" d="M181.19 128.21h-32.48v-26.5h15.38a1.71 1.71 0 0 0 1.71-1.71V71.79h15.38a1.71 1.71 0 0 0 1.71-1.71V53a1.71 1.71 0 0 0-1.71-1.71h-23.92V29.06h8.77a1.71 1.71 0 0 0 1.59-1.1 1.7 1.7 0 0 0-.44-1.87 100 100 0 1 0 0 147.82 1.7 1.7 0 0 0 .44-1.87 1.71 1.71 0 0 0-1.59-1.1h-8.77v-13.67h23.93a1.71 1.71 0 0 0 1.71-1.71v-25.65a1.71 1.71 0 0 0-1.71-1.7zM3.63 95.67v-.06a95.82 95.82 0 0 1 10.45-39.52l.72-1.39h21.1a1.71 1.71 0 1 0 0-3.42H16.56l2.59-4a96.26 96.26 0 0 1 136.53-26.07l4.12 2.93-4.8 1.6a1.71 1.71 0 0 0-1.16 1.62v23.92h-15.39a1.71 1.71 0 1 0 0 3.42h41v13.68H164.1a1.71 1.71 0 0 0-1.71 1.71v28.2H3.63v-2.62zm175.82 58.18h-23.9a1.71 1.71 0 0 0-1.71 1.71v17.09a1.71 1.71 0 0 0 1.16 1.62l4.8 1.6-4.12 2.93a96.26 96.26 0 0 1-136.53-26.11l-2.59-4h27.89a1.71 1.71 0 1 0 0-3.42H14.79l-.72-1.39a95.81 95.81 0 0 1-6.92-17.56l-.93-3.26h55.32a1.71 1.71 0 0 0 0-3.42H5.45l-.39-2.1a96.55 96.55 0 0 1-1.46-13.17l-.12-2.68H145.3v26.5h-23.94a1.71 1.71 0 0 0 0 3.42h58.09v22.23z"/></svg>',
    size: 6,
    answer: {
      correct: 'Всё верно, всего четыре фильма. Снимать кинофантастику в докомпьютерную эру было крайне тяжело. Работа над первым фильмом саги настолько утомила режиссёра, что после неё он не снимал 22 года, но затем срежиссировал три эпизода оригинальной трилогии.',
      less: 'Нет, нужно было шесть гигабайт. Всего таких фильмов четыре. Джорджа Лукаса настолько утомила съёмка первого эпизода, что после него он не снимал 22 года. Затем Лукас вернулся в режиссёрское кресло, чтобы снять оригинальную трилогию.',
      more: 'Всего таких фильмов четыре, на них бы ушло шесть гигабайт трафика. Джорджа Лукаса настолько утомила съёмка первого эпизода, что после него он не снимал 22 года. Затем Лукас вернулся в режиссёрское кресло, чтобы снять три эпизода оригинальной трилогии.'
    }
  }, {
    ...
    answer: {
      ...
      less: 'Всего на канале «вДудь» 16 таких интервью, то есть около четырёх гигабайт трафика. За бортом оказалось несколько рэперов, но неизвестно, потеряли ли вы что-то, не посмотрев их.',
      more: 'Это больше, чем нужно. Всего на канале «вДудь» 16 таких интервью, на них уйдёт около четырёх гигабайт трафика. Возможно, в будущем их станет гораздо больше.'
    }
  }, {
    ...
    notice: '',
    img: '<svg width="200" height="200" viewBox="0 0 200 200"><path fill="#ec008c" d="M101.27 75.32zM120.37 40.32a44.4 44.4 0 0 0-29.31 5.23C81.74 51 74.8 59.94 71 71.5c-4.66 14.37-3 27.71 4.25 37.74 5.79 8 14.73 13 23.48 13.4H99.96a22.71 22.71 0 0 0 22.42-19.33l4-.25c2 7.33 1.65 15.63-1.13 24.21-5.88 18.11-20.4 29.09-38 29.09a44.53 44.53 0 0 1-7-.56c-21.33-3.37-42.47-22.65-42.47-57.43 0-51.66 31.55-77.67 50.3-88.53a2 2 0 0 0 .71-2.66 1.94 1.94 0 0 0-2.66-.71C66.59 17.84 33.9 44.77 33.9 98.41c0 16.93 4.9 31.7 14.05 42.82a51.67 51.67 0 0 0 31.7 18.46 46.87 46.87 0 0 0 7.32.58 43.54 43.54 0 0 0 22-5.81c9.32-5.45 16.26-14.38 20-25.94 4.66-14.37 3-27.71-4.25-37.74-5.8-8-14.77-13-23.53-13.4H100a22.71 22.71 0 0 0-22.42 19.23l-4 .24c-2-7.31-1.63-15.6 1.15-24.15 6.65-20.5 24.35-31.8 45-28.54 21.33 3.37 42.47 22.65 42.47 57.43 0 50.85-30.76 76.85-49 87.79a1.94 1.94 0 0 0 1 3.61 1.92 1.92 0 0 0 1-.28c19.06-11.39 50.94-38.32 50.94-91.13 0-16.93-4.9-31.7-14.05-42.82a51.67 51.67 0 0 0-31.7-18.46M100 81.22A18.78 18.78 0 1 1 81.22 100 18.8 18.8 0 0 1 100 81.22z"/><path fill="#d24b91" d="M186.28.57a1.94 1.94 0 0 0-2.75 0l-13.14 13.15a2 2 0 0 0 0 2.75l13.14 13.15a1.95 1.95 0 0 0 2.75 0l13.15-13.15a1.95 1.95 0 0 0 0-2.75zm-1.38 24.92l-10.4-10.4 10.4-10.4 10.39 10.4zM16.47 170.39a1.94 1.94 0 0 0-2.75 0L.57 183.53a1.94 1.94 0 0 0 0 2.75l13.15 13.15a1.95 1.95 0 0 0 2.75 0l13.15-13.15a1.94 1.94 0 0 0 0-2.75zm-1.38 24.91L4.7 184.91l10.4-10.39 10.4 10.39z"/><path fill="#00b9
.85 2.43 1.21 3.66a2 2 0 0 0 1.88 1.4zM175.13 44.29c-.78-1.11-1.61-2.22-2.47-3.28a1.94 1.94 0 0 0-1.52-.72 1.92 1.92 0 0 0-1.22.43 2 2 0 0 0-.29 2.74c.8 1 1.58 2 2.32 3.08a1.95 1.95 0 1 0 3.18-2.25zM184.81 77h-.11a1.94 1.94 0 0 0-1.84 2c.07 1.28.1 2.59.1 3.88a1.95 1.95 0 0 0 3.89 0c0-1.36 0-2.74-.11-4.09a1.94 1.94 0 0 0-1.93-1.79zM161.55 31a1.93 1.93 0 0 0-.77-1.27c-1.1-.8-2.24-1.59-3.4-2.32a1.95 1.95 0 0 0-2.09 3.28c1.09.69 2.16 1.42 3.19 2.18a1.95 1.95 0 0 0 3.07-1.87zM72.75 44.46a1.93 1.93 0 0 0-1.12-.35 2 2 0 0 0-1.59.83c-.77 1.1-1.53 2.25-2.26 3.41a1.95 1.95 0 1 0 3.3 2.06c.69-1.11 1.41-2.19 2.15-3.23a2 2 0 0 0-.48-2.72zM104.62 21.65a1.94 1.94 0 0 0-2.47-1.22c-1.3.44-2.59.93-3.85 1.45a1.95 1.95 0 1 0 1.49 3.59c1.18-.49 2.39-.95 3.61-1.36a2 2 0 0 0 1.22-2.46zM141.35 24.07a1.946 1.946 0 1 0 1.21-3.7c-1.3-.42-2.63-.81-3.94-1.15a1.95 1.95 0 1 0-1 3.77c1.27.32 2.51.68 3.73 1.08zM85.3 29.71a1.92 1.92 0 0 0-1.18.4 60.99 60.99 0 0 0-3.17 2.61 1.95 1.95 0 0 0 2.57 2.92c1-.85 2-1.68 3-2.45a1.95 1.95 0 0 0-1.22-3.48zM124.3 19.08a2 2 0 0 0-1.94-1.95c-1.36 0-2.72 0-4.06.13a1.95 1.95 0 0 0 .12 3.89h.12c1.26-.08 2.55-.12 3.82-.12a2 2 0 0 0 1.94-1.95zM17.14 121c-.07-1.27-.1-2.58-.1-3.88a1.95 1.95 0 1 0-3.89 0c0 1.37 0 2.74.11 4.08a2 2 0 0 0 1.93 1.8h.11a1.94 1.94 0 0 0 1.84-2zM20.94 139.84c-.44-1.21-.85-2.44-1.21-3.67a1.94 1.94 0 0 0-2.42-1.31 1.94 1.94 0 0 0-1.31 2.42 65.9 65.9 0 0 0 1.29 3.9 1.944 1.944 0 1 0 3.65-1.34z"/></svg>',
    size: 5,
    answer: {
      correct: 'Вы правы. Если бы каждая звезда на этом снимке превратилась в песчинку, то их бы хватило на украшение аквариума.',
      less: 'Нет, этого количества не хватит на всю фотографию. Понадобится больше четырёх гигабайт. Придётся рассматривать галактику самостоятельно — в бинокле она похожа на маленький размытый овал.',
      more: 'Это даже больше, чем нужно, фотография занимает 4,3Гб. Может и хватило бы на остальные звёзды, но телескопу «Хаббл» уже почти тридцать лет,  и фотографировать ещё лучше он не умеет.'
    }
  }, {
