...
exports.default = {
  questions: [{
    ...
    answer: {
      correct: {
        title: 'Точно.',
        text: 'Столько весят 15 альбомов группы. Последний был записан без Фредди Меркьюри — с помощью записей его голоса.'
      },
      less: {
        title: 'Нет, все песни так не послушать.',
        text: 'Группа записала в студии 15 альбомов, это полтора гигабайта. Последний был записан без Фредди Меркьюри — с помощью записей его голоса.'
      },
      more: {
