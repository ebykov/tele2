...
exports.default = {
  questions: [{
    ...
    notice: 'На один альбом в MP3 нужно в среднем 95 мегабайт.',
    ...
    answer: {
      correct: {
        title: 'Точно.',
        text: 'Группа записала в студии 15 альбомов, это полтора гигабайта. Последний был выпущен уже без Фредди Меркьюри — использовались записи его голоса.'
      },
      less: {
    ...
    notice: 'На каждые полчаса нужно 250 мегабайт.',
    ...
    answer: {
      correct: {
        title: 'Идеально.',
        text: 'Странно, что есть люди, которые не только досматривают такие видео, но и снимают на них десятичасовые реакции.'
      },
      less: {
      ...
      more: {
        title: 'Многовато.',
        text: 'Там было всего пять гигабайт. Странно, что есть люди, которые не только досматривают такие видео, но и снимают на них десятичасовые реакции.'
      }
    }
  }, {
    text: 'Джордж Лукас, отец «Звёздных войн», снял далеко не все эпизоды киносаги.',
    ...
    answer: {
      correct: {
        ...
        text: 'Работа над первым фильмом настолько утомила режиссёра, что после неё он не снимал 22 года, но затем снял ещё три эпизода.'
      },
      less: {
        title: 'Нет, нужно было шесть гигабайт.',
        text: 'Всего таких фильмов четыре. Работа над первым фильмом настолько утомила режиссёра, что после неё он не снимал 22 года, но затем снял ещё три эпизода.'
      },
      more: {
    ...
    notice: 'Передача с рэпером весит в среднем 250 мегабайт.',
    img: '<svg width="494.97" height="180" viewBox="0 0 494.97 180"><path class="neon-a" d="M352.78 56.39a9.8 9.8 0 0 0-9.76-10.66h-3.36a15.25 15.25 0 0 0-15.28 14l-3.63 41.36a8.51 8.51 0 0 1-8.52 7.8h-31.42a16.77 16.77 0 0 0-16.75 16.75v1.81a9.53 9.53 0 0 0 9.52 9.52h8.77l-.6 1.95-6.63 21.66v.06l-5.07 16.55a2.17 2.17 0 1 0 4.15 1.27l4.28-14 .33-1.07h52.67l.33 1.07 4.28 14a2.175 2.175 0 1 0 4.16-1.27l-12-39.29-.46-1.45 1.48-.42a25.49 25.49 0 0 0 5.73-2.4 2.17 2.17 0 0 0 .8-3 2.17 2.17 0 0 0-3-.8 21.21 21.21 0 0 1-10.53 2.8h-48.68a5.18 5.18 0 0 1-5.18-5.18v-1.81a12.42 12.42 0 0 1 12.4-12.4h31.42a12.83 12.83 0 0 0 12.85-11.79l3.63-41.36a10.93 10.93 0 0 1 11-10h3.35a5.45 5.45 0 0 1 5.42 5.92l-5 57.27a21.33 21.33 0 0 1-.88 4.47 2.17 2.17 0 0 0 1.43 2.72 2.17 2.17 0 0 0 2.72-1.43 25.69 25.69 0 0 0 1.06-5.38zm-66.2 81.66l.33-1.07h36.51l.33 1.07 5.85 19.09.6 1.95h-50l.6-1.95z"/><path class="neon-b" d="M232.22 127.45v-1.81a16.77 16.77 0 0 0-16.74-16.75h-31.43a8.51 8.51 0 0 1-8.52-7.8l-3.63-41.36a15.26 15.26 0 0 0-15.28-14h-3.35a9.8 9.8 0 0 0-9.79 10.66
h11.31l.23.68a38.86 38.86 0 0 0 28 25.4 2.6 2.6 0 0 0 3.19-2.54L96.72 2.6A2.6 2.6 0 0 0 93.48.07a38.84 38.84 0 0 0-27.59 24.55l-.24.66H40.48a2.6 2.6 0 0 0-2.6 2.6v19.34a2.6 2.6 0 0 0 2.6 2.6h8.41v13.53H37.75v-4a2.6 2.6 0 0 0-2.6-2.6h-8.48a2.6 2.6 0 0 0-2.6 2.6v13.18a2.6 2.6 0 0 0 2.6 2.6h8.49a2.6 2.6 0 0 0 2.6-2.6v-4H48.9v30.64h-8.48a2.59 2.59 0 0 0-2.32 1.42L.28 175.12a2.6 2.6 0 1 0 4.63 2.33l20.49-40.37.63-1.24 1 1 21.58 21.61.29.29v17.56a2.6 2.6 0 1 0 5.2 0v-17.4l.29-.29 21.66-21.65 1-1 .63 1.24 20.41 40.25a2.6 2.6 0 0 0 4.63-2.35zm25.25-94l1.32-.58v1.43l.13 61v1.47l-1.32-.47a33.76 33.76 0 0 1-.13-62.9zM32.55 62.97v7h-3.28v-8h3.29v1zm16.35 42.4v46l-1.72-1.72-18.16-18.15-.54-.51.33-.65 12.9-25.42.28-.55h6.89v1zm-4.8-60.75h-1V30.45h21.17l-.19 1.2a38.07 38.07 0 0 0-.12 11.8l.17 1.15h-20zm29.94 87l-18.22 18.21-1.72 1.72v-47.18h6.89l.28.55 13 25.53.33.65z"/><path class="neon-b" d="M83.94 31.37a2.6 2.6 0 0 0-2.6 2.6v22.32a2.6 2.6 0 1 0 5.2 0V33.97a2.6 2.6 0 0 0-2.6-2.6zM83.94 19.45a2.6 2.6 0 0 0-2.6 2.6v1.9a2.6 2.6 0 1 0 5.2 0v-1.89a2.6 2.6 0 0 0-2.6-2.61z"/></svg>',
    size: 4,
    answer: {
      correct: {
        title: 'В десятку.',
      ...
      less: {
        ...
        text: 'Всего на канале «вДудь» 16 таких интервью, рэп читает каждый пятый гость Юры.'
      },
      more: {
    ...
    notice: 'На час общения с одним человеком нужно 450 мегабайт.',
    ...
    answer: {
      ...
      less: {
        ...
        text: 'Разговор оборвался на рецептах оладушек. Нужно было около трёх гигабайт.'
      },
      more: {
    ...
    text: 'В 2015 году орбитальный телескоп «Хаббл» снял гигантскую фотографию галактики Андромеды. Разрешение снимка составляет 1545 мегапикселей.',
    title: 'Сколько трафика нужно на его изучение?',
    notice: 'Это примерно в тысячу раз больше обычной цифровой фотографии.',
    ...
    answer: {
      ...
      more: {
        title: 'Это больше, чем нужно.',
        text: 'Фотографии хватит пяти гигабайт. Телескопу «Хаббл» уже почти тридцать лет,  и фотографировать ещё лучше он не умеет.'
      }
    }
  }, {
    ...
    answer: {
      ...
      less: {
        ...
        text: 'Ничего ты не знаешь, Джон Сноу. Непрерывное прослушивание всех книг займёт неделю и восемь гигабайт трафика.'
      },
      more: {
